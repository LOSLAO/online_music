...
public class MusicDao {
    ...
    public List<Music> findLoveMusic(int user_id){
        ...
        try {
            String sql = "select m.id as music_id,title,singer,time,url,userid from " +
                    "lovemusic lm, music m where lm.music_id=m.id and user_id=?";
            connection = DBUtils.getConnection();
            ps = connection.prepareStatement(sql);
            ps.setInt(1, user_id);
            rs = ps.executeQuery();
    ...
    public  List<Music> ifMusicLove(String str,int user_id){
        ...
        try {
            String sql = "select m.id as music_id,title,singer,time,url,userid from\n" +
                    "lovemusic lm,music m where lm.music_id=m.id and user_id=? and title like '%"+str+"%'";
            connection = DBUtils.getConnection();
            ps = connection.prepareStatement(sql);
            ps.setInt(1, user_id);
            rs = ps.executeQuery();
    ...
    public static void main(String[] args) {
        //List<Music> musicList = ifMusicLove("香", 1);
        //System.out.println(musicList);
        //System.out.println(removeLoveMusic(1, 2));
        //System.out.println(insertLoveMusic(1, 2));
        //List<Music> musicList = findLoveMusic(1);
        //System.out.println(musicList);
        //System.out.println(removeLoveMusic(1, 7));
        //System.out.println(removeLoveMusic(1, 8));

        //System.out.println(deleteMusicById(7));
       //System.out.println(deleteMusicById(10));

        //insert("稻香", "周杰伦", "2020-07-29", "music\\稻香", 1);
        //System.out.println(insertLoveMusic(1, 9));

    }
//        insert("稻香", "周杰伦", "2020-0727", "music\\稻香", 1);
        //System.out.println(insertLoveMusic(1, 2));
//    }
